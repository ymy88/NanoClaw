...
Gemini on Vertex AI day-by-day, writes a context file, deletes JSONL
transcripts and session records, and signals the running NanoClaw process
to clear its in-memory cache.
...
def main():
    ...
    parser.add_argument("--dry-run", action="store_true", help="Only generate the summary file, skip session reset and container check")
